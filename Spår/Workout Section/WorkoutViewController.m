...
@property (weak, nonatomic) IBOutlet UILabel *otherGenLabel;
...
- (void)viewDidLoad {
    ...
    //Setting up initial graphics for the buttons and labels
    ...
    _seeAll.layer.cornerRadius = 10;
    [_seeAll.layer setShadowOffset:CGSizeMake(5, 5)];
    [_seeAll.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_seeAll.layer setShadowOpacity:0.5];
    
    [_genLabel.layer setShadowOffset:CGSizeMake(5, 5)];
    [_genLabel.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_genLabel.layer setShadowOpacity:0.5];
    
    [_otherGenLabel.layer setShadowOffset:CGSizeMake(5, 5)];
    [_otherGenLabel.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_otherGenLabel.layer setShadowOpacity:0.5];
    
    [_prevLabel.layer setShadowOffset:CGSizeMake(5, 5)];
    [_prevLabel.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_prevLabel.layer setShadowOpacity:0.5];
    
    _workoutTable.layer.cornerRadius = 10;
    _workoutTable.backgroundColor = [UIColor clearColor];
    [_workoutTable.layer setShadowOffset:CGSizeMake(5, 5)];
    [_workoutTable.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_workoutTable.layer setShadowOpacity:0.5];
    
    _workoutPicker.layer.cornerRadius = 10;
    [_workoutPicker.layer setShadowOffset:CGSizeMake(5, 5)];
    [_workoutPicker.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_workoutPicker.layer setShadowOpacity:0.5];
    ...
    [[_ref child:@"workouts"]
              ...
              withBlock:^(FIRDataSnapshot *snapshot) {
                ...
                while (child = [children nextObject]) {
                    ...
                    //[self.workoutTable insertRowsAtIndexPaths:@[[NSIndexPath indexPathForRow:self.workoutHistory.count - 1 inSection:0]] withRowAnimation:UITableViewRowAnimationAutomatic];
                }
...
- (IBAction)generateWorkoutButtonPressed:(UIButton *)sender {
    ...
    workout.workoutType = @"Your Specialized Workout";
