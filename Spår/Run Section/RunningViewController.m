...
@property (weak, nonatomic) IBOutlet UILabel *distBackLabel;
@property (weak, nonatomic) IBOutlet UILabel *paceBackLabel;
...
- (void)viewDidLoad {
    ...
    _stopLabel.layer.cornerRadius = 5;
    ...
    [_backButton.layer setShadowOffset:CGSizeMake(5, 5)];
    [_backButton.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_backButton.layer setShadowOpacity:0.5];
    
    _timeBackLabel.layer.cornerRadius = 10;
    [_timeBackLabel.layer setShadowOffset:CGSizeMake(5, 5)];
    [_timeBackLabel.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_timeBackLabel.layer setShadowOpacity:0.5];
    
    _distBackLabel.layer.cornerRadius = 10;
    [_distBackLabel.layer setShadowOffset:CGSizeMake(5, 5)];
    [_distBackLabel.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_distBackLabel.layer setShadowOpacity:0.5];
    
    _paceBackLabel.layer.cornerRadius = 10;
    [_paceBackLabel.layer setShadowOffset:CGSizeMake(5, 5)];
    [_paceBackLabel.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_paceBackLabel.layer setShadowOpacity:0.5];
    
    _saveRunButton.layer.cornerRadius = 10;
    [_saveRunButton.layer setShadowOffset:CGSizeMake(5, 5)];
    [_saveRunButton.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_saveRunButton.layer setShadowOpacity:0.5];
...
- (IBAction)stopButtonPressed:(id)sender {
    ...
    - (IBAction)saveRun:(id)sender {
        ...
        UIAlertController *alertVC=[UIAlertController alertControllerWithTitle:@"Adding new run" message:@"Enter a name for this run" preferredStyle:UIAlertControllerStyleAlert];
        ...
        UIAlertAction *action=[UIAlertAction actionWithTitle:@"Submit" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
          NSLog(@"Name submitted");
            self->generatedRunName = alertVC.textFields[0].text;
            
            
            [self submitEntry:self->dict];
            
          NSLog(@"%@ ",self->generatedRunName);
        }];
...
-(void)submitEntry:(NSDictionary*)data {
    
    NSMutableDictionary *mdata = [dict mutableCopy];
    [mdata setObject:generatedRunName forKey:@"name"];
    [[[self->_ref child:@"runs"] child:mdata[@"name"]] setValue:mdata];
    [self InformativeAlertWithmsg:[NSString stringWithFormat:@"New run at %@", mdata[@"name"]]];
}
