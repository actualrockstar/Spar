...
@property (weak, nonatomic) IBOutlet UILabel *prevRuns;
...
- (void)viewDidLoad {
    ...
    [_prevRuns.layer setShadowOffset:CGSizeMake(5, 5)];
    [_prevRuns.layer setShadowColor:[[UIColor blackColor] CGColor]];
    [_prevRuns.layer setShadowOpacity:0.5];
